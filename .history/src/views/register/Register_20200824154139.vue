    ...
    <div class="register">
      <div class="r-register m-t-20">
        <div class="d-f">
          ...
          <div v-if="input.length !==11 && input !==''" class="d-f m-t-10 m-l-10">
            <i class="iconfont icon-shibai"></i>
            <div class="m-l-10">请输入正确的11位手机号码</div>
          </div>
        ...
        <div class="d-f m-t-20">
          ...
          <el-input
            ...
            class="input m-l-55"
          ></el-input>
          <div class="m-l-10 m-t-10">{{datas}}</div>
        </div>
        <div class="d-f m-t-20">
          <div class="m-t-10">创建密码</div>
          <el-input placeholder="请创建密码" v-model="inputss" clearable class="input m-l-25"></el-input>
        </div>
        <div class="d-f m-t-20">
          <div class="m-t-10">确认密码</div>
          <el-input placeholder="请再次确认密码" v-model="inputr" clearable class="input m-l-25"></el-input>
        </div>
