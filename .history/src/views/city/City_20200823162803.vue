  ...
  <div>
    ...
    <div class="d-f m-t-20 m-l-10">
     <div class="m-t-10">按省份选择:</div>
      <el-select v-model="value" placeholder="省份" class="m-l-10">
    <el-option></el-option>
  </el-select>
    <el-select v-model="values" placeholder="城市" class="m-l-20">
    <el-option></el-option>
  </el-select>
    <div class="m-t-10">按省份选择:</div>
      <el-select v-model="value" placeholder="请输入城市中文或拼音" class="m-l-10">
    <el-option></el-option>
  </el-select>
    </div>
    </div>
