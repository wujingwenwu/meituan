  ...
  <div class="d-f j-c-c">
    <div class="seach">
      <div class="d-f p-r">
        ...
        <div class="i-history">
        <div @click="click">
        <el-input placeholder="请输入内容" v-model="input" clearable class="input" @input="inputs" @blur="blur" @change="change"></el-input>
        </div>
         <div class="history" v-if="flag===true&&value ===''"></div>
...
this.flag=true
   ...
   this.flag=false
    ...
    change(value){
      ...
      localStorage.setItem('item',JSON.String(this.item))
    }
  },
  mounted() {
  ...
  this.values=localStorage.getItem(JSON.parse('item'))
