    ...
    <div class="content1">
      <div class="d-f">
        <div class="classification p-r">
          <div v-for="(item,index) in menu" :key="index">
            <div class="classificas">
              <div class="d-f classifica">
                <svg class="icon" aria-hidden="true">
                  <use :xlink:href="`#${item.icon}`" />
                </svg>
                <div class="f-s-12 m-l-10 font" @click="clicks(item)">{{item.name}}</div>
        ...
        <div>
          ...
          <div class="d-f title">
          <div class=" m-l-10">我的订单</div>
          <div class=" m-l-10">我的收藏</div>
          <div class=" m-l-10">抵用券</div>
          <div class=" m-l-10">余额</div>
          <div class=" m-l-10">更多</div>
          </div>
          </div>
          <div class="sogins">
