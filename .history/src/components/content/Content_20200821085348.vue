      ...
      <div class="d-f">
                  ...
                  <div v-for="(item1,index1) in item.child" :key="index1">
                    ...
                    <div class="d-f childs">
                      <div v-for="(item2,index2) in item1.child" :key="index2">
                        <div class="m-l-10 m-t-10 f-c-hu">{{item2}}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div>
          <div class="sogin">
            ...
            <div>Hi! 你好</div>
            <div class="signs">注册</div>
            <div class="signs">立即登录</div>
          </div>
          <div class="sogins">
          <img src="//s1.meituan.net/bs/fe-web-meituan/60ac9a0/img/download-qr.png" alt="" class="">
          </div>
        </div>
      </div>
    </div>
