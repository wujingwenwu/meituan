                  ...
                  <div class="classifications">
                    ...
                    <div class="classifications1">
                      ...
                      <div class="d-f">
                        ...
                        <div v-for="(item1,index1) in item.child" :key="index1" class="d-f">
                          <div v-for="(item2,index2) in item1.child" :key="index2" class="d-f classifications2">
                            <div class="d-f ">
                              <div class=" m-l-10">{{item2}}</div>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="d-f menu">
                <div v-for="(item,index) in areas" :key="index">
                  <div class="regions">
                    ...
                    <div class="region">
                      <div class="m-l-10 hov f-c-hu">{{item.type}}</div>
                      <div class="d-f region1">
                        <div class="m-t-10 f-c-hu m-l-10">全部</div>
                        <div v-for="(item1,index1) in item.module" :key="index1">
                          <div v-if="index1<20" class="m-l-10 m-t-10">{{item1}}</div>
                        </div>
                      </div>
                    </div>
                  </div>
